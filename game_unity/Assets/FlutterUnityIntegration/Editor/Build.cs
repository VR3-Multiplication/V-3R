...
namespace FlutterUnityIntegration.Editor
{
    public class Build : EditorWindow
    {
        ...
        private static readonly string AndroidExportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../app_flutter/android/unityLibrary"));
        private static readonly string WindowsExportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../app_flutter/windows/unityLibrary/data"));
        private static readonly string IOSExportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../app_flutter/ios/UnityLibrary"));
        private static readonly string WebExportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../app_flutter/web/UnityLibrary"));
        private static readonly string IOSExportPluginPath = Path.GetFullPath(Path.Combine(ProjectPath, "../app_flutter/ios_xcode/UnityLibrary"));
...
#unity-mobile-warning { position: absolute; left: 50%; top: 5%; transform: translate(-50%); background: white; padding: 10px; display: none }
        ...
        */
        ...
        {
            var androidPath = Path.GetFullPath(Path.Combine(ProjectPath, "../app_flutter/android"));
            var androidAppPath = Path.GetFullPath(Path.Combine(ProjectPath, "../app_flutter/android/app"));
...
";
        ...
        {
            var iosRunnerPath = Path.GetFullPath(Path.Combine(ProjectPath, "../app_flutter/ios"));
